...
const VehicleList = () => {
  ...
  const { vehicles, selectedShowroom, loading, error, successMessage } =
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <div className="flex-1 relative">
          ...
          <input
            ...
            className={`w-full pl-10 pr-4 py-2.5 ${isDark ? "bg-slate-800/50 border-slate-700/50 text-white placeholder-slate-500" : "bg-white border-slate-300 text-slate-900 placeholder-slate-400"} border rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500/50 text-sm`}
          />
        </div>
        <select
          value={statusFilter}
          onChange={(e) => setStatusFilter(e.target.value)}
          className={`px-4 py-2.5 ${isDark ? "bg-slate-800/50 border-slate-700/50 text-slate-300" : "bg-white border-slate-300 text-slate-900"} border rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/50`}
        >
                ...
                {vehicles.map((v) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td
                        className={`px-4 py-3 text-xs ${isDark ? "text-slate-300" : "text-slate-600"}`}
                      >
                        {v.sellerName}
                      </td>
