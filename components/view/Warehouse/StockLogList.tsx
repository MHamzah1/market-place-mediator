                    ...
                    <div className="flex justify-between items-start">
                      <div>
                        ...
                        {log.warehouseVehicle && (
                          <span
                            className={`ml-2 text-sm font-medium ${isDark ? "text-white" : "text-slate-900"}`}
                          >
...
function SummaryCard({
  ...
  return (
    <div
      className={`${isDark ? "bg-slate-800/50 border-slate-700/50" : "bg-white border-slate-200 shadow-sm"} border rounded-xl p-4 text-center`}
    >
      <p
