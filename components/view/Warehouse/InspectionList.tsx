                        ...
                        {loadingHistory ? (
                          ...
                          <div className="space-y-2 mt-2">
                            {vehicleInspections.map((insp) => (
                              <InspectionHistoryRow key={insp.id} insp={insp} isDark={isDark} />
                            ))}
                          </div>
                        )}
                      </div>
...
const InspectionHistoryRow = ({
  ...
  return (
    ...
    >
      ...
      {/* Approver */}
      {insp.approvedBy && (
        <span className={`flex items-center gap-1 ml-auto ${isDark ? "text-slate-500" : "text-slate-400"}`}>
          <FiUser size={10} />
      ...
      {/* Date */}
      <span className={`${isDark ? "text-slate-500" : "text-slate-400"} ${insp.approvedBy ? "" : "ml-auto"}`}>
